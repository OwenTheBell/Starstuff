...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, input, message }; } }
...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        message.AddEntityIndex(new Entitas.PrimaryEntityIndex<MessageEntity, int>(
            Id,
            message.GetGroup(MessageMatcher.Id),
...
public static class ContextsExtensions {
    ...
    public static MessageEntity GetEntityWithId(this MessageContext context, int value) {
        return ((Entitas.PrimaryEntityIndex<MessageEntity, int>)context.GetEntityIndex(Contexts.Id)).GetEntity(value);
    }
